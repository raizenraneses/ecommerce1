...
public class brgBaconCheese extends AppCompatActivity {

    // Constants
    private static final int MIN_QUANTITY = 1;
    private static final int MAX_QUANTITY = 20;
    private static final int PRODUCT_PRICE = 300;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brg_bacon_cheese);
        ...
        cancelButton.setOnClickListener(v -> {
            Toast.makeText(brgBaconCheese.this, "Order cancelled", Toast.LENGTH_SHORT).show();
            finish();
        });
    ...
    private void placeOrder() {
        Intent receiptIntent = new Intent(brgBaconCheese.this, receiptFile.class);

        // Pass all necessary data to receipt
        receiptIntent.putExtra("productName", "Bacon Cheese Burger");
